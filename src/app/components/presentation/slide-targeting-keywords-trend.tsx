...
const KEYWORDS_INIT: Keyword[] = [
  { keyword: 'remote desktop',                  msv: '74K',   kd: 100, dec: 12,  jan: 15,  feb: 18, mar: 58, apr: 34, trend: -22  },
  { keyword: 'remote desktop software',         msv: '3.6K',  kd: 98,  dec: 11,  jan: 8,   feb: 5,  mar: 13, apr: 50, trend: -39  },
  { keyword: 'remote access',                   msv: '8.1K',  kd: 100, dec: 3,   jan: 10,  feb: 4,  mar: 6,  apr: 3,  trend:  0   },
  { keyword: 'remote access software',          msv: '3.6K',  kd: 98,  dec: 10,  jan: 10,  feb: 7,  mar: 8,  apr: 16, trend: -6   },
  { keyword: 'remote support',                  msv: '4.4K',  kd: 100, dec: 10,  jan: 7,   feb: 8,  mar: 31, apr: 25, trend: -15  },
  { keyword: 'remote support software',         msv: '1.9K',  kd: 59,  dec: 9,   jan: 9,   feb: 4,  mar: 8,  apr: 5,  trend:  4   },
  { keyword: 'teamviewer alternative',          msv: '1.9K',  kd: 45,  dec: 4,   jan: 4,   feb: 4,  mar: 4,  apr: 4,  trend:  0   },
  { keyword: 'teamviewer pricing',              msv: '1K',    kd: 39,  dec: 8,   jan: 8,   feb: 8,  mar: 6,  apr: 5,  trend:  3   },
  { keyword: 'logmein alternative',             msv: '210',   kd: 25,  dec: 2,   jan: 2,   feb: 2,  mar: 3,  apr: 5,  trend: -3   },
  { keyword: 'logmein pricing',                 msv: '320',   kd: 37,  dec: 7,   jan: 7,   feb: 7,  mar: 9,  apr: 8,  trend: -1   },
  { keyword: 'anydesk alternative',             msv: '590',   kd: 28,  dec: 101, jan: 42,  feb: 42, mar: 41, apr: 41, trend: 60   },
  { keyword: 'anydesk pricing',                 msv: '590',   kd: 32,  dec: 5,   jan: 5,   feb: 7,  mar: 7,  apr: 7,  trend: -2   },
  { keyword: 'patch management',                msv: '2.9K',  kd: 37,  dec: 58,  jan: 55,  feb: 58, mar: 21, apr: 14, trend: 44   },
  { keyword: 'patch management software',       msv: '1.3K',  kd: 25,  dec: 67,  jan: 62,  feb: 57, mar: 32, apr: 66, trend:  1   },
  { keyword: 'autonomous endpoint management',  msv: '170',   kd: 18,  dec: 7,   jan: 8,   feb: 7,  mar: 4,  apr: 4,  trend:  3   },
];
  ...
  return (
    <SlideContainer slideNumber={7} onNavigateHome={onNavigateHome} source="GSC">
      <SlideHeader
        ...
        subtitle="Dec 2025 – Apr 2026 (Source: GSC· Country: US)"
      />
      ...
      <div className="flex items-center justify-between mb-3">
        <span className="text-sm font-bold text-gray-800">Ranking Trend: Dec → Jan → Feb → Mar → Apr</span>
      ...
      <div className="flex-1 border border-gray-200 rounded-xl overflow-hidden flex flex-col min-h-0">
        ...
        <div className="grid bg-gray-50 border-b border-gray-200 px-4 py-2.5"
             style={{ gridTemplateColumns: '2fr 0.6fr 0.7fr 0.5fr 0.5fr 0.5fr 0.5fr 0.5fr 0.65fr' }}>
          {['KEYWORD','MSV','KD','DEC','JAN','FEB','MAR','APR','TREND'].map(h => (
          ...
          {isEditing ? (
            ...
            keywords.map((kw, i) => (
              ...
              >
                ...
                />
                {(['dec','jan','feb','mar','apr'] as const).map(f => (
                  <input
                    key={f}
                    type="number"
                    value={kw[f] ?? ''}
            ...
            keywords.map((kw, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xs text-gray-700 font-medium">{kw.apr ?? '—'}</span>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="rounded-xl p-4 border" style={{ backgroundColor: '#F0FDF4', borderColor: '#BBF7D0' }}>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-bold text-green-800">Rankings Improved Dec → Apr</span>
            </div>
            <p className="text-xs text-green-700 leading-relaxed">
              <strong>{improved.length} keywords</strong> improved their ranking position from Dec → Apr, including{' '}
              <strong>anydesk alternative (+60)</strong> and{' '}
              <strong>patch management (+44 positions)</strong>.
            </p>
          </div>
