...
const missingKeywordsData = [
  { keyword: 'remote desktop for windows',      intent: 'Informational',               volume: 880, kd: 66, cpc: 0, cd: 0, ft: 0, pa: 3, cp: 7,  cisco: 82, cs: 25 },
  { keyword: 'remote desktop free',             intent: 'Commercial, Informational',   volume: 590, kd: 82, cpc: 0, cd: 0, ft: 0, pa: 2, cp: 3,  cisco: 7,  cs: 24 },
  { keyword: 'remote desktop sharing',          intent: 'Informational',               volume: 390, kd: 91, cpc: 0, cd: 0, ft: 0, pa: 3, cp: 4,  cisco: 47, cs: 27 },
  { keyword: 'free remote access to computer',  intent: 'Commercial, Informational',   volume: 320, kd: 77, cpc: 0, cd: 0, ft: 0, pa: 1, cp: 8,  cisco: 56, cs: 5  },
  { keyword: 'remote access software free',     intent: 'Commercial',                  volume: 210, kd: 55, cpc: 0, cd: 0, ft: 0, pa: 1, cp: 4,  cisco: 15, cs: 13 },
  { keyword: 'remotely connect to pc',          intent: 'Informational',               volume: 140, kd: 69, cpc: 0, cd: 0, ft: 0, pa: 4, cp: 3,  cisco: 73, cs: 8  },
  { keyword: 'control a computer remotely',     intent: 'Informational',               volume: 110, kd: 97, cpc: 0, cd: 0, ft: 0, pa: 4, cp: 5,  cisco: 63, cs: 11 },
];

// Untapped Keywords Data (Image 2)
const untappedKeywordsData = [
  { keyword: 'remote viewing',                  intent: 'Informational', volume: 18100, kd: 74, cpc: 0, cd: 0, ft: 0, pa: 0,  cp: 70, cisco: 0,  cs: 0  },
  { keyword: 'endpoint protection',             intent: 'Commercial',    volume: 5400,  kd: 49, cpc: 0, cd: 0, ft: 0, pa: 0,  cp: 0,  cisco: 76, cs: 0  },
  { keyword: 'patch management software',       intent: 'Commercial',    volume: 1900,  kd: 40, cpc: 0, cd: 0, ft: 0, pa: 0,  cp: 0,  cisco: 44, cs: 0  },
  { keyword: 'remote desktop connection for mac', intent: 'Informational', volume: 1600,  kd: 54, cpc: 0, cd: 0, ft: 0, pa: 0,  cp: 10, cisco: 0,  cs: 45 },
];
...
const multiCompetitorData = [
  ...
  { keyword: 'remote access software for windows',    intent: 'Commercial, Informational', volume: 480, kd: 64,  ft: 49, pa: 2,  cp: 9,  cisco: 24, cs: 10 },
  { keyword: 'remote desktop connection for windows', intent: 'Informational',             volume: 390, kd: 37,  ft: 94, pa: 93, cp: 15, cisco: 89, cs: 29 },
  { keyword: 'remote desktop support software',       intent: 'Commercial',                volume: 390, kd: 66,  ft: 35, pa: 3,  cp: 5,  cisco: 14, cs: 12 },
];
