...
const OPPS_MONTHS = ['2025-10', '2025-11', '2025-12', '2026-01', '2026-02', '2026-03', '2026-04'];
...
// ─── Organic Keywords (total, Oct 2025 – Apr 2026) ──────────────────────────
const ORGANIC_KEYWORDS_OPPS: Record<string, number[]> = {
  splashtop:   [58000, 58000, 59000, 64000, 68000, 59000, 50000],
  teamviewer:  [79000, 78000, 81000, 86000, 89000, 87000, 89000],
  anydesk:     [97000, 87000, 82000, 89000, 83000, 64000, 52000],
  beyondtrust: [42000, 39000, 29000, 29000, 31000, 28000, 25000],
  gotomypc:    [14000, 13000, 12000, 13000, 12000,  8000,  6000],
};

// ─── Page-1 Keywords (Oct 2025 – Apr 2026) ──────────────────────────────────
const PAGE_ONE_KEYWORDS_OPPS: Record<string, number[]> = {
  splashtop:   [6000, 6000, 7000, 8000, 8000, 9000, 9000],
  teamviewer:  [11000, 11000, 11000, 11000, 11000, 12000, 14000],
  anydesk:     [6000, 6000, 6000, 7000, 7000, 6000, 6000],
  beyondtrust: [3000, 3000, 3000, 3000, 3000, 3000, 3000],
  gotomypc:    [1000, 1000, 1000, 1000, 1000, 1000, 1000],
};
...
export function SlideOpportunities({ onNavigateHome }: SlideOpportunitiesProps) {
      ...
      return (
        <InsightsSection>
          <InsightCard
            ...
            type="error"
            title="Splashtop"
            content={<>From Oct 2025 to Apr 2026, keywords decreased <strong>~58K → ~50K (−13.8%)</strong>, peaking at <strong>68K</strong> in Feb before decline.</>}
          />
          <InsightCard
            icon={TrendingUp}
            type="success"
            title="Competitions"
            content={<>TeamViewer grew <strong>79K → 89K (+12.7%)</strong>, while AnyDesk declined significantly <strong>97K → 52K (−46.4%)</strong>.</>}
          />
        </InsightsSection>
      );
    } else {
      return (
        <InsightsSection>
          <InsightCard
            ...
            type="success"
            title="Splashtop"
            content={<>From Oct 2025 to Apr 2026, page-1 rankings grew <strong>~6K → ~9K (+50%)</strong>, strong improvement in top SERP visibility.</>}
          />
          <InsightCard
            icon={TrendingUp}
            type="success"
            title="Competitions"
            content={<>TeamViewer increased <strong>11K → 14K (+27.3%)</strong>, while AnyDesk remained stable at <strong>6K (0%)</strong>.</>}
          />
        </InsightsSection>
      );
    }
  ...
  const getPerformanceSummary = () => {
    const latestIdx = OPPS_MONTHS.length - 1; // Apr 2026
