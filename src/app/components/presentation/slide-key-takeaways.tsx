...
const takeaways: Takeaway[] = [
  {
    ...
    iconBg: 'bg-red-50',
    iconColor: '#EF4444',
    metricBadge: 'TRAFFIC GROWTH +23%',
    metricBg: 'bg-red-500',
    metricText: '174K',
    title: 'Strongest Organic Traffic Growth Continues',
    body: 'Reached its highest traffic at 174K in Apr, maintaining steady growth while competitors showed moderate fluctuations.',
  },
  {
    id: 'non-branded',
    index: '2',
    ...
    iconBg: 'bg-blue-50',
    iconColor: '#3B82F6',
    metricBadge: 'NON-BRANDED TRAFFIC +108%',
  ...
  },
  {
    ...
    iconBg: 'bg-purple-50',
    iconColor: '#8B5CF6',
    metricBadge: 'PAGE-1 KEYWORDS +50%',
    metricBg: 'bg-purple-500',
    metricText: '+50%',
    title: 'Strategic Shift Toward High-Value Rankings',
    body: 'Page-1 keywords grew from 6K to 9K (Oct–Apr), reflecting a strategic focus on quality rankings over total keyword volume.',
  },
  {
    id: 'ai-visibility',
    index: '4',
    ...
    iconBg: 'bg-amber-50',
    iconColor: '#F59E0B',
    metricBadge: 'AI KEYWORDS +116% | AI TRAFFIC +222%',
  ...
  },
  {
    ...
    iconColor: '#10B981',
    metricBadge: 'TRAFFIC GROWTH +72% (Remote Access)',
    metricBg: 'bg-emerald-500',
    metricText: '+72%',
    title: 'Core Categories Driving Consistent Growth',
    body: 'Remote access, remote desktop, and remote support categories continue to drive performance, showing strong improvements and consistent growth momentum across the board.',
  },
  {
    ...
    iconBg: 'bg-sky-50',
    iconColor: '#0EA5E9',
    metricBadge: 'REFERRING DOMAINS +13.1%',
    metricBg: 'bg-sky-500',
    metricText: '+13.1%',
  ...
  return (
    <SlideContainer slideNumber={22} onNavigateHome={onNavigateHome} source="">
      ...
      <div className="text-xs text-gray-500 mb-4">
        Apr 2026 · Splashtop vs. Competitors
      </div>
