...
// Remote Desktop — Oct 2025 → Apr 2026
const TOTAL_KEYWORDS_INIT = {
  splashtop:   [523, 500, 542, 556, 527, 554, 559],
  teamviewer:  [402, 350, 363, 371, 355, 348, 349],
  anydesk:     [588, 510, 517, 512, 494, 415, 416],
  beyondtrust: [ 23,   9,   8,   8,   8,   8,   8],
  gotomypc:    [290, 228, 237, 232, 205, 128, 130],
};
const PAGE_ONE_INIT = {
  splashtop:   [305, 362, 369, 392, 367, 451, 455],
  teamviewer:  [249, 265, 263, 263, 249, 280, 281],
  anydesk:     [356, 376, 374, 366, 348, 319, 319],
  beyondtrust: [  6,   4,   4,   4,   4,   6,   6],
  gotomypc:    [108, 108, 104,  96,  79,  54,  56],
};
const TRAFFIC_INIT = {
  splashtop:   [1045, 1717, 1389, 2103, 1394, 1625, 1636],
  teamviewer:  [2666, 3798, 3086, 4277, 3325, 5597, 5534],
  anydesk:     [2186, 6305, 3116, 2730, 2801, 2957, 2986],
  beyondtrust: [  49,   49,    7,    6,   24,   60,   61],
  gotomypc:    [ 948,  539,  748,  837,  410,  313,  337],
};
